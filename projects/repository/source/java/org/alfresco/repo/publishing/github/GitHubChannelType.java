 ...
 * @since 4.0
 */
public class GitHubChannelType extends AbstractChannelType
{
    ...
    private GitHubPublishingHelper githubPublishingHelper;
    private String redirectUri = DEFAULT_REDIRECT_URI;

    public void setPublishingHelper(GitHubPublishingHelper githubPublishingHelper)
    {
        this.githubPublishingHelper = githubPublishingHelper;
    }
    ...
    {
        return GitHubPublishingModel.TYPE_DELIVERY_CHANNEL;
    }
    ...
    {
        Connection<GitHub> connection = githubPublishingHelper.getGithubConnectionForChannel(channel.getNodeRef());
    ...
    public AuthUrlPair getAuthorisationUrls(Channel channel, String callbackUrl)
    {
        ...
        OAuth2Operations oauthOperations = githubPublishingHelper.getConnectionFactory().getOAuthOperations();
            ...
            Map<String, String[]> callbackParams)
    {
        ...
        else if (callbackParams.containsKey("code"))
        {
            ...
            OAuth2Operations oauthOps = githubPublishingHelper.getConnectionFactory().getOAuthOperations();
