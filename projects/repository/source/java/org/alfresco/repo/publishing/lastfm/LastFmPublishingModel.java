 ...
 * @since 4.0
 */
public interface LastFmPublishingModel
{
    public static final String NAMESPACE = "http://www.alfresco.org/model/publishing/lastFm/1.0";
    public static final String PREFIX = "lastFm";
