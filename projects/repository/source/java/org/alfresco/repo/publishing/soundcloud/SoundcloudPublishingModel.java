 ...
 * @since 4.0
 */
public interface SoundcloudPublishingModel
{
    public static final String NAMESPACE = "http://www.alfresco.org/model/publishing/soundcloud/1.0";
    public static final String PREFIX = "soundcloud";
