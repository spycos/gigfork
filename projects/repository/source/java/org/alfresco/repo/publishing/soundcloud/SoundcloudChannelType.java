...
public class SoundcloudChannelType extends AbstractChannelType
{
    public final static String ID = "soundcloud";
    public final static String DEFAULT_REDIRECT_URI = "http://alfresco.com/stand-alone-auth-return.html";

    private SoundcloudPublishingHelper soundcloudPublishingHelper;
    private String redirectUri = DEFAULT_REDIRECT_URI;

    public void setPublishingHelper(SoundcloudPublishingHelper soundcloudPublishingHelper)
    {
        this.soundcloudPublishingHelper = soundcloudPublishingHelper;
    }
    ...
    {
        return SoundcloudPublishingModel.TYPE_DELIVERY_CHANNEL;
    }
    ...
    {
        Connection<SoundCloud> connection = soundcloudPublishingHelper.getSoundcloudConnectionForChannel(channel.getNodeRef());
    ...
    public AuthUrlPair getAuthorisationUrls(Channel channel, String callbackUrl)
    {
        ...
        OAuth2Operations oauthOperations = soundcloudPublishingHelper.getConnectionFactory().getOAuthOperations();
        
        
        //FIXME: check hot to hale this
        Map<String, List<String>> urlcalls = null;
		OAuth2Parameters params = new OAuth2Parameters(urlcalls);
            ...
            Map<String, String[]> callbackParams)
    {
        ...
        else if (callbackParams.containsKey("code"))
        {
            ...
            OAuth2Operations oauthOps = soundcloudPublishingHelper.getConnectionFactory().getOAuthOperations();
