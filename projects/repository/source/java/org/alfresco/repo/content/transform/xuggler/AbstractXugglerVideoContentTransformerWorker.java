 ...
 */
package org.alfresco.repo.content.transform.xuggler;
 ...
 * @author Derek Hulley
 */
public abstract class AbstractXugglerVideoContentTransformerWorker extends ContentTransformerHelper implements ContentTransformerWorker, InitializingBean
{
    /** the prefix for mimetypes supported by the transformer */
    public static final String MIMETYPE_IMAGE_PREFIX = "image/";
    
    private static final Log logger = LogFactory.getLog(AbstractXugglerVideoContentTransformerWorker.class);
    
    private boolean available;
    
    public AbstractXugglerVideoContentTransformerWorker()
    {
    ...
    public boolean isTransformable(String sourceMimetype, String targetMimetype, TransformationOptions options)
    {
        ...
        if (!AbstractXugglerVideoContentTransformerWorker.isSupported(sourceMimetype) ||
                !AbstractXugglerVideoContentTransformerWorker.isSupported(targetMimetype))
        {
