 ...
 * @author Derek Hulley
 */
public class XugglerVideoContentTransformerWorker extends AbstractXugglerVideoContentTransformerWorker
{
    ...
    private static final Log logger = LogFactory.getLog(XugglerVideoContentTransformerWorker.class);
     ...
     * Default constructor
     */
    public XugglerVideoContentTransformerWorker()
    {
        // Intentionally empty
    }
