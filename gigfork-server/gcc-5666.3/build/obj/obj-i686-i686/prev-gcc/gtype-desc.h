...
enum gt_types_enum {
 ...
 gt_ggc_e_19cfstring_descriptor, 
 gt_ggc_e_20machopic_indirection, 
 ...
 gt_ggc_e_20VEC_inlined_entry_gc, 
 gt_ggc_e_17VEC_dw_die_ref_gc, 
 ...
 gt_e_P19cfstring_descriptor4htab, 
 gt_e_P20machopic_indirection4htab, 
...
#define gt_ggc_m_20VEC_inlined_entry_gc(X) do { \
  if (X != NULL) gt_ggc_mx_VEC_inlined_entry_gc (X);\
  } while (0)
extern void gt_ggc_mx_VEC_inlined_entry_gc (void *);
#define gt_ggc_m_17VEC_dw_die_ref_gc(X) do { \
  if (X != NULL) gt_ggc_mx_VEC_dw_die_ref_gc (X);\
  } while (0)
extern void gt_ggc_mx_VEC_dw_die_ref_gc (void *);
...
#define gt_ggc_m_18qualified_typeinfo(X) do { \
  if (X != NULL) gt_ggc_mx_qualified_typeinfo (X);\
  } while (0)
extern void gt_ggc_mx_qualified_typeinfo (void *);
...
#define gt_pch_n_20VEC_inlined_entry_gc(X) do { \
  if (X != NULL) gt_pch_nx_VEC_inlined_entry_gc (X);\
  } while (0)
extern void gt_pch_nx_VEC_inlined_entry_gc (void *);
#define gt_pch_n_17VEC_dw_die_ref_gc(X) do { \
  if (X != NULL) gt_pch_nx_VEC_dw_die_ref_gc (X);\
  } while (0)
extern void gt_pch_nx_VEC_dw_die_ref_gc (void *);
...
#define gt_pch_n_18qualified_typeinfo(X) do { \
  if (X != NULL) gt_pch_nx_qualified_typeinfo (X);\
  } while (0)
extern void gt_pch_nx_qualified_typeinfo (void *);
...
extern void gt_pch_p_16limbo_die_struct
    (void *, void *, gt_pointer_operator, void *);
extern void gt_pch_p_20VEC_inlined_entry_gc
    (void *, void *, gt_pointer_operator, void *);
extern void gt_pch_p_17VEC_dw_die_ref_gc
    (void *, void *, gt_pointer_operator, void *);
...
extern void gt_pch_p_13dw_cfi_struct
    (void *, void *, gt_pointer_operator, void *);
extern void gt_pch_p_18qualified_typeinfo
    (void *, void *, gt_pointer_operator, void *);
