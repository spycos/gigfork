...
const struct ggc_root_tab gt_ggc_r_gtype_desc_c[] = {
  ...
  },
  {
    ...
    1,
    sizeof (generic_block_literal_struct_type),
    &gt_ggc_mx_tree_node,
    &gt_pch_nx_tree_node
  },
  {
  ...
  {
    &darwin_sections[0],
    1 * (NUM_DARWIN_SECTIONS),
    sizeof (darwin_sections[0]),
    &gt_ggc_mx_section,
    &gt_pch_nx_section
  },
  LAST_GGC_ROOT_TAB
...
const struct ggc_root_tab gt_pch_rs_gtype_desc_c[] = {
  ...
  { &darwin_reverse_bitfields, 1, sizeof (darwin_reverse_bitfields), NULL, NULL },
  { &darwin_ms_struct, 1, sizeof (darwin_ms_struct), NULL, NULL },
  LAST_GGC_ROOT_TAB
};
