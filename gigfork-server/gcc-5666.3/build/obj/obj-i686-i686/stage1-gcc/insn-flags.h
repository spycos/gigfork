...
#define HAVE_fixuns_truncdfhi2 (TARGET_SSE2 && TARGET_SSE_MATH)
#define HAVE_fixuns_truncsfhi2 (TARGET_SSE2 && TARGET_SSE_MATH)
...
#define HAVE_bswapsi2 (TARGET_BSWAP)
#define HAVE_bswapdi2 (TARGET_64BIT && TARGET_BSWAP)
...
#define HAVE_sse_movntv1di (TARGET_SSE || TARGET_3DNOW_A)
...
#define HAVE_mmx_addv1di3 (TARGET_MMX && ix86_binary_operator_ok (PLUS, V1DImode, operands))
...
#define HAVE_mmx_subv1di3 (TARGET_MMX)
...
#define HAVE_mmx_ashrv4hi2si (TARGET_MMX)
#define HAVE_mmx_ashrv2si2si (TARGET_MMX)
#define HAVE_mmx_lshrv4hi3 (TARGET_MMX)
#define HAVE_mmx_lshrv2si3 (TARGET_MMX)
#define HAVE_mmx_lshrv1di3 (TARGET_MMX)
#define HAVE_mmx_lshrv4hi2si (TARGET_MMX)
#define HAVE_mmx_lshrv2si2si (TARGET_MMX)
#define HAVE_mmx_lshrv1di2si (TARGET_MMX)
#define HAVE_mmx_ashlv4hi3 (TARGET_MMX)
#define HAVE_mmx_ashlv2si3 (TARGET_MMX)
#define HAVE_mmx_ashlv1di3 (TARGET_MMX)
#define HAVE_mmx_ashlv4hi2si (TARGET_MMX)
#define HAVE_mmx_ashlv2si2si (TARGET_MMX)
#define HAVE_mmx_ashlv1di2si (TARGET_MMX)
...
#define HAVE_mmx_andv1di3 (TARGET_MMX && ix86_binary_operator_ok (AND, V1DImode, operands))
#define HAVE_mmx_nandv8qi3 (TARGET_MMX)
#define HAVE_mmx_nandv4hi3 (TARGET_MMX)
#define HAVE_mmx_nandv2si3 (TARGET_MMX)
#define HAVE_mmx_nandv1di3 (TARGET_MMX)
...
#define HAVE_mmx_iorv1di3 (TARGET_MMX && ix86_binary_operator_ok (IOR, V1DImode, operands))
...
#define HAVE_mmx_xorv1di3 (TARGET_MMX && ix86_binary_operator_ok (XOR, V1DImode, operands))
...
#define HAVE_sse_loadqv4si (TARGET_SSE)
#define HAVE_sse_storeqv4si (TARGET_SSE)
#define HAVE_sse_movqv4si (TARGET_SSE)
...
#define HAVE_sse2_umulv2siv2di3 (TARGET_SSE2 && ix86_binary_operator_ok (MULT, V4SImode, operands))
#define HAVE_sse4_1_mulv2siv2di3 (TARGET_SSE4_1 && ix86_binary_operator_ok (MULT, V4SImode, operands))
...
#define HAVE_sse4_1_smaxv16qi3 (TARGET_SSE4_1 && ix86_binary_operator_ok (SMAX, V16QImode, operands))
#define HAVE_sse4_1_smaxv4si3 (TARGET_SSE4_1 && ix86_binary_operator_ok (SMAX, V4SImode, operands))
#define HAVE_sse4_1_umaxv8hi3 (TARGET_SSE4_1 && ix86_binary_operator_ok (UMAX, V8HImode, operands))
#define HAVE_sse4_1_umaxv4si3 (TARGET_SSE4_1 && ix86_binary_operator_ok (UMAX, V4SImode, operands))
...
#define HAVE_sse4_1_eqv2di3 (TARGET_SSE4_1 && ix86_binary_operator_ok (EQ, V2DImode, operands))
...
#define HAVE_sse4_1_sminv16qi3 (TARGET_SSE4_1 && ix86_binary_operator_ok (SMIN, V16QImode, operands))
#define HAVE_sse4_1_sminv4si3 (TARGET_SSE4_1 && ix86_binary_operator_ok (SMIN, V4SImode, operands))
#define HAVE_sse4_1_uminv8hi3 (TARGET_SSE4_1 && ix86_binary_operator_ok (UMIN, V8HImode, operands))
#define HAVE_sse4_1_uminv4si3 (TARGET_SSE4_1 && ix86_binary_operator_ok (UMIN, V4SImode, operands))
...
#define HAVE_ssse3_pmaddubswv8hi3 (TARGET_SSSE3)
#define HAVE_ssse3_pmaddubswv4hi3 (TARGET_SSSE3)
#define HAVE_ssse3_pmulhrswv8hi3 (TARGET_SSSE3 && ix86_binary_operator_ok (MULT, V8HImode, operands))
#define HAVE_ssse3_pmulhrswv4hi3 (TARGET_SSSE3 && ix86_binary_operator_ok (MULT, V4HImode, operands))
...
#define HAVE_ssse3_palignrv1di (TARGET_SSSE3)
#define HAVE_ssse3_pabsv16qi2 (TARGET_SSSE3)
#define HAVE_ssse3_pabsv8hi2 (TARGET_SSSE3)
#define HAVE_ssse3_pabsv4si2 (TARGET_SSSE3)
#define HAVE_ssse3_pabsv8qi2 (TARGET_SSSE3)
#define HAVE_ssse3_pabsv4hi2 (TARGET_SSSE3)
#define HAVE_ssse3_pabsv2si2 (TARGET_SSSE3)
...
#define HAVE_sse4_1_roundpd (TARGET_SSE4_1)
#define HAVE_sse4_1_roundps (TARGET_SSE4_1)
#define HAVE_sse4_1_roundsd (TARGET_SSE4_1)
...
#define HAVE_fixuns_truncsfsi2 (!TARGET_64BIT && SSE_FLOAT_MODE_P (SFmode) && TARGET_SSE_MATH && TARGET_SSE2 \
   && !optimize_size && (ix86_preferred_stack_boundary >= 128))
#define HAVE_fixuns_truncdfsi2 (!TARGET_64BIT && SSE_FLOAT_MODE_P (DFmode) && TARGET_SSE_MATH && TARGET_SSE2 \
   && !optimize_size && (ix86_preferred_stack_boundary >= 128))
...
#define HAVE_floatunssidf2 (!TARGET_64BIT && TARGET_SSE2 && TARGET_SSE_MATH \
   && (ix86_preferred_stack_boundary >= 128))
#define HAVE_floatunsdisf2 (TARGET_64BIT && TARGET_SSE_MATH)
#define HAVE_floatunsdidf2 ((TARGET_64BIT || !optimize_size) && TARGET_SSE2 && TARGET_SSE_MATH \
   && (ix86_preferred_stack_boundary >= 128))
...
#define HAVE_negtf2 (TARGET_64BIT)
#define HAVE_abstf2 (TARGET_64BIT)
...
#define HAVE_cmpstrnsi ((! optimize_size || TARGET_INLINE_ALL_STRINGOPS) && !TARGET_64BIT)
#define HAVE_cmpintqi 1
#define HAVE_cmpstrnqi_nz_1 1
#define HAVE_cmpstrnqi_1 1
#define HAVE_darwin_cmpstrnqi_nz_1 1
#define HAVE_darwin_cmpstrqi_1 1
...
extern rtx        gen_sse_movntv1di                          (rtx, rtx);
...
extern rtx        gen_mmx_ashrv4hi2si                        (rtx, rtx, rtx);
extern rtx        gen_mmx_ashrv2si2si                        (rtx, rtx, rtx);
extern rtx        gen_mmx_lshrv4hi3                          (rtx, rtx, rtx);
extern rtx        gen_mmx_lshrv2si3                          (rtx, rtx, rtx);
extern rtx        gen_mmx_lshrv1di3                          (rtx, rtx, rtx);
extern rtx        gen_mmx_lshrv4hi2si                        (rtx, rtx, rtx);
extern rtx        gen_mmx_lshrv2si2si                        (rtx, rtx, rtx);
extern rtx        gen_mmx_lshrv1di2si                        (rtx, rtx, rtx);
extern rtx        gen_mmx_ashlv4hi3                          (rtx, rtx, rtx);
extern rtx        gen_mmx_ashlv2si3                          (rtx, rtx, rtx);
extern rtx        gen_mmx_ashlv1di3                          (rtx, rtx, rtx);
extern rtx        gen_mmx_ashlv4hi2si                        (rtx, rtx, rtx);
extern rtx        gen_mmx_ashlv2si2si                        (rtx, rtx, rtx);
extern rtx        gen_mmx_ashlv1di2si                        (rtx, rtx, rtx);
...
extern rtx        gen_sse_loadqv4si                          (rtx, rtx);
extern rtx        gen_sse_storeqv4si                         (rtx, rtx);
extern rtx        gen_sse_movqv4si                           (rtx, rtx);
...
extern rtx        gen_sse4_1_smaxv16qi3                      (rtx, rtx, rtx);
extern rtx        gen_sse4_1_smaxv4si3                       (rtx, rtx, rtx);
extern rtx        gen_sse4_1_umaxv8hi3                       (rtx, rtx, rtx);
extern rtx        gen_sse4_1_umaxv4si3                       (rtx, rtx, rtx);
...
extern rtx        gen_sse4_1_sminv16qi3                      (rtx, rtx, rtx);
extern rtx        gen_sse4_1_sminv4si3                       (rtx, rtx, rtx);
extern rtx        gen_sse4_1_uminv8hi3                       (rtx, rtx, rtx);
extern rtx        gen_sse4_1_uminv4si3                       (rtx, rtx, rtx);
...
extern rtx        gen_ssse3_pmaddubswv8hi3                   (rtx, rtx, rtx);
extern rtx        gen_ssse3_pmaddubswv4hi3                   (rtx, rtx, rtx);
...
extern rtx        gen_ssse3_palignrv1di                      (rtx, rtx, rtx, rtx);
extern rtx        gen_ssse3_pabsv16qi2                       (rtx, rtx);
extern rtx        gen_ssse3_pabsv8hi2                        (rtx, rtx);
extern rtx        gen_ssse3_pabsv4si2                        (rtx, rtx);
extern rtx        gen_ssse3_pabsv8qi2                        (rtx, rtx);
extern rtx        gen_ssse3_pabsv4hi2                        (rtx, rtx);
extern rtx        gen_ssse3_pabsv2si2                        (rtx, rtx);
...
extern rtx        gen_sse4_2_pcmpestr_cconly                 (rtx, rtx, rtx, rtx, rtx);
...
extern rtx        gen_sse4_2_pcmpistr_cconly                 (rtx, rtx, rtx);
...
extern rtx        gen_darwin_cmpstrnqi_nz_1                  (rtx, rtx, rtx, rtx, rtx, rtx, rtx, rtx);
extern rtx        gen_darwin_cmpstrqi_1                      (rtx, rtx, rtx, rtx, rtx, rtx, rtx, rtx);
