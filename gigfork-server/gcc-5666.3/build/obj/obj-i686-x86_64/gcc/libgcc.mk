...
./libgcc_s.dylib: stmp-dirs 
	/Users/hflambo/local/alfresco-svn/root-02-04-2012/gigfork-server/gcc-5666.3/build/obj/obj-i686-x86_64/./gcc/xgcc -B/Users/hflambo/local/alfresco-svn/root-02-04-2012/gigfork-server/gcc-5666.3/build/obj/obj-i686-x86_64/./gcc/ -B/usr/x86_64-apple-darwin11/bin/ -B/usr/x86_64-apple-darwin11/lib/ -isystem /usr/x86_64-apple-darwin11/include -isystem /usr/x86_64-apple-darwin11/sys-include  -O2  -O2 -g -O2   -DIN_GCC    -W -Wall -Wwrite-strings -Wstrict-prototypes -Wmissing-prototypes -Wold-style-definition  -isystem ./include  -fPIC -pipe -g -DHAVE_GTHR_DEFAULT -DIN_LIBGCC2 -D__GCC_FLOAT_NOT_NEEDED  -dynamiclib -nodefaultlibs -install_name /usr/lib/libgcc_s`if test . = ppc64 ; then echo _. ; fi`.1.dylib -single_module -o ./libgcc_s.1.dylib.tmp -Wl,-exported_symbols_list,libgcc/./libgcc.map -compatibility_version 1 -current_version 1.0  $(objects) -lc
all: ./libgcc_s.dylib
