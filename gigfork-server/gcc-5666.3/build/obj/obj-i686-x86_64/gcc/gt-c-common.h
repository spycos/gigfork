...
const struct ggc_root_tab gt_ggc_r_gt_c_common_h[] = {
  {
    ...
    1,
    sizeof (block_object_dispose_func_decl),
    &gt_ggc_mx_tree_node,
    &gt_pch_nx_tree_node
  },
  {
    &block_object_assign_decl,
    1,
    sizeof (block_object_assign_decl),
    &gt_ggc_mx_tree_node,
    &gt_pch_nx_tree_node
  },
  {
...
const struct ggc_root_tab gt_pch_rs_gt_c_common_h[] = {
  { &iasm_saw_frfree_blr, 1, sizeof (iasm_saw_frfree_blr), NULL, NULL },
  { &iasm_delete_blr, 1, sizeof (iasm_delete_blr), NULL, NULL },
