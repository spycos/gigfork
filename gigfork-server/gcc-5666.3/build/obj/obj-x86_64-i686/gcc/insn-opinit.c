...
init_all_optabs (void)
{
  ...
  if (HAVE_fixuns_truncdfhi2)
    ufixtrunc_optab->handlers[HImode][DFmode].insn_code = CODE_FOR_fixuns_truncdfhi2;
  if (HAVE_fixuns_truncsfhi2)
    ufixtrunc_optab->handlers[HImode][SFmode].insn_code = CODE_FOR_fixuns_truncsfhi2;
  if (HAVE_floathixf2)
  ...
  if (HAVE_bswapsi2)
    bswap_optab->handlers[SImode].insn_code = CODE_FOR_bswapsi2;
  if (HAVE_bswapdi2)
    bswap_optab->handlers[DImode].insn_code = CODE_FOR_bswapdi2;
  if (HAVE_sqrtxf2)
  ...
  if (HAVE_movv1di)
    mov_optab->handlers[V1DImode].insn_code = CODE_FOR_movv1di;
  if (HAVE_movv2sf)
  ...
  if (HAVE_pushv1di1)
    push_optab->handlers[V1DImode].insn_code = CODE_FOR_pushv1di1;
  ...
  if (HAVE_movmisalignv1di)
    movmisalign_optab->handlers[V1DImode].insn_code = CODE_FOR_movmisalignv1di;
  if (HAVE_vec_setv2sf)
