...
#define BLOCK_POINTER_TYPE_CHECK(t)	TREE_CHECK (t, BLOCK_POINTER_TYPE)
...
#define MULT_UCH_EXPR_CHECK(t)	TREE_CHECK (t, MULT_UCH_EXPR)
...
#define BRACKET_EXPR_CHECK(t)	TREE_CHECK (t, BRACKET_EXPR)
...
#define OBJC_WEAK_REFERENCE_EXPR_CHECK(t)	TREE_CHECK (t, OBJC_WEAK_REFERENCE_EXPR)
#define OBJC_PROPERTY_REFERENCE_EXPR_CHECK(t)	TREE_CHECK (t, OBJC_PROPERTY_REFERENCE_EXPR)
#define OBJC_STRING_REFERENCE_CHECK(t)	TREE_CHECK (t, OBJC_STRING_REFERENCE)
