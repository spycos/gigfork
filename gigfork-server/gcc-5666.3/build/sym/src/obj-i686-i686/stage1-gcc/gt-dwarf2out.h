...
void
gt_ggc_mx_VEC_inlined_entry_gc (void *x_p)
{
  struct VEC_inlined_entry_gc * const x = (struct VEC_inlined_entry_gc *)x_p;
  if (ggc_test_and_set_mark (x))
    {
      {
        size_t i0;
        for (i0 = 0; i0 != (size_t)(((*x).base).num); i0++) {
          gt_ggc_m_10die_struct ((*x).base.vec[i0].origin_die);
          gt_ggc_m_17VEC_dw_die_ref_gc ((*x).base.vec[i0].inlined_instances);
        }
      }
    }
}
...
void
gt_ggc_mx_VEC_dw_die_ref_gc (void *x_p)
{
  struct VEC_dw_die_ref_gc * const x = (struct VEC_dw_die_ref_gc *)x_p;
  if (ggc_test_and_set_mark (x))
    {
      {
        size_t i0;
        for (i0 = 0; i0 != (size_t)(((*x).base).num); i0++) {
          gt_ggc_m_10die_struct ((*x).base.vec[i0]);
        }
      }
    }
}
...
void
gt_pch_nx_VEC_inlined_entry_gc (void *x_p)
{
  struct VEC_inlined_entry_gc * const x = (struct VEC_inlined_entry_gc *)x_p;
  if (gt_pch_note_object (x, x, gt_pch_p_20VEC_inlined_entry_gc, gt_ggc_e_20VEC_inlined_entry_gc))
    {
      {
        size_t i0;
        for (i0 = 0; i0 != (size_t)(((*x).base).num); i0++) {
          gt_pch_n_10die_struct ((*x).base.vec[i0].origin_die);
          gt_pch_n_17VEC_dw_die_ref_gc ((*x).base.vec[i0].inlined_instances);
        }
      }
    }
}
...
void
gt_pch_nx_VEC_dw_die_ref_gc (void *x_p)
{
  struct VEC_dw_die_ref_gc * const x = (struct VEC_dw_die_ref_gc *)x_p;
  if (gt_pch_note_object (x, x, gt_pch_p_17VEC_dw_die_ref_gc, gt_ggc_e_17VEC_dw_die_ref_gc))
    {
      {
        size_t i0;
        for (i0 = 0; i0 != (size_t)(((*x).base).num); i0++) {
          gt_pch_n_10die_struct ((*x).base.vec[i0]);
        }
      }
    }
}
...
void
gt_pch_p_20VEC_inlined_entry_gc (ATTRIBUTE_UNUSED void *this_obj,
	void *x_p,
	ATTRIBUTE_UNUSED gt_pointer_operator op,
	ATTRIBUTE_UNUSED void *cookie)
{
  struct VEC_inlined_entry_gc * const x ATTRIBUTE_UNUSED = (struct VEC_inlined_entry_gc *)x_p;
  {
    size_t i0;
    for (i0 = 0; i0 != (size_t)(((*x).base).num); i0++) {
      if ((void *)(x) == this_obj)
        op (&((*x).base.vec[i0].origin_die), cookie);
      if ((void *)(x) == this_obj)
        op (&((*x).base.vec[i0].inlined_instances), cookie);
    }
  }
}

void
gt_pch_p_17VEC_dw_die_ref_gc (ATTRIBUTE_UNUSED void *this_obj,
	void *x_p,
	ATTRIBUTE_UNUSED gt_pointer_operator op,
	ATTRIBUTE_UNUSED void *cookie)
{
  struct VEC_dw_die_ref_gc * const x ATTRIBUTE_UNUSED = (struct VEC_dw_die_ref_gc *)x_p;
  {
    size_t i0;
    for (i0 = 0; i0 != (size_t)(((*x).base).num); i0++) {
      if ((void *)(x) == this_obj)
...
const struct ggc_root_tab gt_ggc_r_gt_dwarf2out_h[] = {
  ...
  },
  {
    &debug_inlined_table,
    1,
    sizeof (debug_inlined_table),
    &gt_ggc_mx_VEC_inlined_entry_gc,
    &gt_pch_nx_VEC_inlined_entry_gc
  },
  {
    &pubtype_table,
    1,
